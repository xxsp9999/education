...
<meta charset="UTF-8">
<title>导员信息列表</title>
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/instructor/list.css">
</head>
<body>
<!--面包屑  -->
<div id="head">
...
function drawTable(){
		...
		$("#table").jqGrid({
			...
			colModel: [
				...
				{name: 'instructorSex', index: 'instructorSex', align: 'center'},
				{name: 'instructorBirth', index: 'instructorBirth', align: 'center'},
				{name: 'instructorPhone', index: 'instructorPhone', align: 'center'},
				{name: 'instructorEmail', index: 'instructorEmail', align: 'center'},
				{name: 'instructorId', index: 'instructorId', align: 'center'},
			...
			ondblClickRow:function(id){
				window.location.href="${pageContext.request.contextPath}/instructor/toAdd?id="+id+"&operate=update";
			}
		});
	}
	...
	.navButtonAdd('#pager', {
		...
		onClickButton: function(){//按钮点击函数
	       window.location.href="${pageContext.request.contextPath}/instructor/toAdd?operate=add";
		}
	}).navButtonAdd('#pager', {
		caption: '修改',
		...
		onClickButton: function(){//按钮点击函数
			...
			window.location.href="${pageContext.request.contextPath}/instructor/toAdd?id="+id+"&operate=show";
		}
	}).navButtonAdd('#pager', {
		caption: '删除',
		...
		$("#searchBtn").click(function(){
			 $("#table").jqGrid("setGridParam", {
	                   url: "${pageContext.request.contextPath}/instructor/getList",
	                   mtype: "post",
	                   dataType: "json",
	                   postData: {	                	   	             
	                	   //start: $("#test3").val(),
