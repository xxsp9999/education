...
function drawTable(){
		...
		$("#table").jqGrid({
			...
			ondblClickRow:function(id){
				window.location.href="${pageContext.request.contextPath}/course/toAdd?id="+id+"&operate=update";
			}
	  	  });
		};
	...
	.navButtonAdd('#pager', {
		...
		onClickButton: function(){//按钮点击函数
	       window.location.href="${pageContext.request.contextPath}/course/toAdd?operate=add";
		}
	}).navButtonAdd('#pager', {
		caption: '修改',
		...
		onClickButton: function(){//按钮点击函数
			...
			window.location.href="${pageContext.request.contextPath}/course/toAdd?id="+id+"&operate=show";
		}
	})  .navButtonAdd('#pager', {
		caption: '删除',
