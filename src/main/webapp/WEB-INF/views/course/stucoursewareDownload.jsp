...
function drawTable(){
		...
		$("#table").jqGrid({
			url:path+"/courseware/getStuCourseList?content="+content,
			datatype: 'json',
			...
			ondblClickRow:function(id){
				 window.location.href="${pageContext.request.contextPath}/courseware/toDownLoad?id="+id;
			}
	  	  });
		};
	  ...
	  function updatePagerIcons(table) {
		...
		$("#searchBtn").click(function(){
			 $("#table").jqGrid("setGridParam", {
	                   url: "${pageContext.request.contextPath}/courseware/getStuCourseList",
	                   mtype: "post",
	                   dataType: "json",
	                   postData: {	                	   	             
	                	   start: $("#test3").val(),
