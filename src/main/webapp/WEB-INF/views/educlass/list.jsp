...
<meta charset="UTF-8">
<title>班级信息列表</title>
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/class/list.css">
<style type="text/css">
	.ui-left{
		 padding-left: 20%;
	}
...
function drawTable(){
		...
		$("#table").jqGrid({
			url:path+"/educlass/getList?content="+content,
			datatype: 'json',
			...
			width: jqTablew,
			height: 350,
			colNames: [/* '班级号', */'班级名称','所属年级','班主任','备注'],
			colModel: [
				/* {name: 'claNumber', index: 'claNumber', align: 'center'}, */
				{name: 'claName', index: 'facName', align: 'center'},
				{name: 'claGrade.gradeName', index: 'claGrade.gradeName', align: 'center'},
				{name: 'claHeadteacher.teaName', index: 'claHeadteacher.teaName', align: 'center'},
				{name: 'claRemark', index: 'claRemark', align: 'center'},
			],
			rowNum: 10,		//每页显示多少条
			...
			ondblClickRow:function(id){
				window.location.href="${pageContext.request.contextPath}/educlass/toAdd?id="+id+"&operate=update";
			}
	  	  });
		};
	...
	.navButtonAdd('#pager', {
		...
		onClickButton: function(){//按钮点击函数
	       window.location.href="${pageContext.request.contextPath}/educlass/toAdd?operate=add";
		}
	}).navButtonAdd('#pager', {
		caption: '修改',
		...
		onClickButton: function(){//按钮点击函数
			...
			window.location.href="${pageContext.request.contextPath}/educlass/toAdd?id="+id+"&operate=show";
		}
	}) .navButtonAdd('#pager', {
		caption: '删除',
	  ...
	  function updatePagerIcons(table) {
		...
		$("#searchBtn").click(function(){
			 $("#table").jqGrid("setGridParam", {
	                   url: "${pageContext.request.contextPath}/educlass/getList",
	                   mtype: "post",
	                   dataType: "json",
	                   postData: {	                	   	             
	                	   start: $("#test3").val(),
