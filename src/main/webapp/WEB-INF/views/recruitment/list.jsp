...
<div id="search" style="height:40px">
	...
	<!--jQgrid  -->
	<h2 id="jqTableTitle">招聘信息信息列表</h2>
...
function drawTable(){
		...
		$("#table").jqGrid({
			...
			ondblClickRow:function(id){
				window.location.href="${pageContext.request.contextPath}/company/toRecruitmentAdd?id="+id+"&operate=update";
			}
	  	  });
		};
	...
	.navButtonAdd('#pager', {
		...
		onClickButton: function(){//按钮点击函数
	       window.location.href="${pageContext.request.contextPath}/company/toRecruitmentAdd?operate=add";
		}
	}).navButtonAdd('#pager', {
		caption: '修改',
