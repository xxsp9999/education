...
<body>
<img style="position: absolute;top: 0px;left: 0px"  src="${pageContext.request.contextPath}/processDefinition/showView?deploymentId=${deploymentId}&diagramResourceName=${diagramResourceName}">
