...
function drawTable(){
		...
		$("#table").jqGrid({
			url:path+"/company/getCompanyList?content="+content,
			datatype: 'json',
			...
			colModel: [
				...
				{name: 'companyTel', index: 'companyTel', align: 'center'},
				{name: 'companyEmail', index: 'companyEmail', align: 'center'},
				{name: 'uscc', index: 'uscc', align: 'center'},
				{name: 'organizationCode', index: 'organizationCode', align: 'center'},
				{name: 'companyAddress', index: 'companyAddress', align: 'center'},
				{name: 'companyWebsite', index: 'companyWebsite', align: 'center',width:"250px"},
				{name: 'companyRemark', index: 'companyRemark', align: 'center'},
			],
			rowNum: 10,		//每页显示多少条
			...
			ondblClickRow:function(id){
				window.location.href="${pageContext.request.contextPath}/company/toCompanyAdd?id="+id+"&operate=update";
			}
	  	  });
		};
	...
	.navButtonAdd('#pager', {
		...
		onClickButton: function(){//按钮点击函数
	       window.location.href="${pageContext.request.contextPath}/company/toCompanyAdd?operate=add";
		}
	}).navButtonAdd('#pager', {
		caption: '修改',
		...
		onClickButton: function(){//按钮点击函数
			...
			window.location.href="${pageContext.request.contextPath}/company/toCompanyAdd?id="+id+"&operate=show";
		}
	})  .navButtonAdd('#pager', {
		caption: '删除',
	  ...
	  function updatePagerIcons(table) {
		...
		$("#searchBtn").click(function(){
			 $("#table").jqGrid("setGridParam", {
	                   url: "${pageContext.request.contextPath}/company/getCompanyList",
	                   mtype: "post",
	                   dataType: "json",
	                   postData: {	                	   	             
	                	   start: $("#test3").val(),
