 ...
 * 杨世明
 * 
 * var costomerId="clientCode";
 * autocompletePlus3(customerHead,costomerData,costomerId,"clientCode","clientId","setNameid");
 */
function autocompletePlus3(head,data,firstId,secendId,linkmanId,saleId) {
		/*- 自定义的表头 -
