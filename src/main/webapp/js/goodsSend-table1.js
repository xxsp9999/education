...
function pageInit(){
   ...
   jQuery("#table").jqGrid({
		...
		height: "280px",
       	colNames:['序号','出库单号','合同号','代理商简称','承运商','最终客户','数量','体积','订单类型 ','包装物类型','包装料品','出货日期','DC区域'],
       	colModel:[
         	{name:'id',index:'id',width:70,align:"center",hidden:true},
         	{name:'number',index:'number',width:140,align:"center"},
	        {name:'contractNumber',index:'contractNumber',width:184,align:"center"},
	        {name:'agent',index:'agent',width:102,align:"center"},
	        {name:'carrier',index:'carrier',width:100,align:"center"},
	        {name:'finalCustomerAddress',index:'finalCustomerAddress',width:113,align:"center"},
	        {name:'amount',index:'amount',width:68,align:"center"},
	        {name:'volume',index:'volume',width:68,align:"center"},
	        {name:'orderType',index:'orderType',width:106,align:"center"},
	        {name:'goodsType',index:'goodsType',width:117,align:"center"},
	        {name:'packingMaterial',index:'packingMaterial',width:168,align:"center"},
	        {name:'deliverDate',index:'deliverDate',width:155,align:"center"},
	        {name:'dcWarehouse',index:'dcWarehouse',width:100,align:"center"}
       	],
       	rowNum:8,
       	/*rowList:[10,20,30],*/
       	pager: '#toolsbar',
